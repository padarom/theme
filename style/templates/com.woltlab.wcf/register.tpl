...
{include file='header' __disableLoginLink=true __disableAds=true light=true title='wcf.user.register'|language paddingBottom=30}
...
<form method="post" action="{link controller='Register'}{/link}">
	<div class="container containerPadding marginTop">
		...
		<div class="text-center">
			<button class="btn btn-primary btn-3d">{lang}wcf.global.button.submit{/lang}</button>

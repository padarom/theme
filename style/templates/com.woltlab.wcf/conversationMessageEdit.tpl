...
{include file='header' title='wcf.conversation.message.edit'|language light=true}
...
<div class="container" style="margin-bottom:30px;">
	...
	<form id="messageContainer" class="jsFormGuard" method="post" action="{link controller='ConversationMessageEdit' id=$messageID}{/link}">
		<div class="containerPadding marginTop">
			{if $isFirstMessage}
				<fieldset>
		...
		<div class="text-center">
			...
			{if $isFirstMessage && $conversation->isDraft}<button name="draft" class="btn btn-secondary btn-3d" accesskey="d" value="1">{lang}wcf.conversation.button.saveAsDraft{/lang}</button>{/if}
